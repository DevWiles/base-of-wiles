      ...
      <div className="mx-auto flex max-w-5xl flex-col-reverse items-center gap-10 md:flex-row md:items-center md:justify-between">
        <div className="flex w-full flex-col justify-center md:w-2/3">
          ...
          <p className="mt-4 text-sm leading-relaxed text-black md:text-base">
            毕业于广东工业大学自动化专业，在校期间系统学习了数据结构、操作系统、计算机网络等核心课程，奠定了扎实的理论基础。获得过校级奖学金，并参与大学生创新创业训练计划项目，做过深度学习相关科研，具备良好的学习能力和实践精神。
          </p>
          <p className="mt-4 text-sm leading-relaxed text-black md:text-base">
          ...
          <p className="mt-4 text-sm leading-relaxed text-black md:text-base">
            在数据库方面，熟练使用 MySQL 等数据库管理系统，掌握索引优化、查询优化、事务隔离级别等核心技术。同时熟悉 Redis、MongoDB 等 NoSQL 数据库，能够根据业务场景选择合适的存储方案。具备分布式系统设计经验，了解 CAP 理论、BASE 理论，实践过分布式锁、分布式事务、消息队列等技术方案。
          </p>
          <p className="mt-4 text-sm leading-relaxed text-black md:text-base">
          ...
          <p className="mt-4 text-sm leading-relaxed text-black md:text-base">
            具备一定的全栈开发能力，熟悉 Vue.js、React 等前端框架，了解 HTML5、CSS3、JavaScript/TypeScript 等前端技术。能够独立完成从需求分析、系统设计、编码实现到部署运维的完整开发流程。对 DevOps 文化有深入理解，熟练使用 Git、Maven、Docker等工具，具备 CI/CD 流水线搭建和维护经验。
          </p>
          <p className="mt-4 text-sm leading-relaxed text-black md:text-base">
            热爱技术，喜欢折腾，保持持续学习的态度，关注行业最新技术动态。平时喜欢在 GitHub 上参与开源项目，在技术博客上分享学习心得。具备良好的团队协作精神和沟通能力，能够快速融入团队并为项目贡献力量。期待与有志之士一起，用技术创造价值，打造优秀的产品。
          </p>
